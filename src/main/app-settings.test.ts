...
describe('AppSettingsStore', () => {
  it('recovers from corrupt data and keeps provider readiness separate', () => {
    ...
    try {
      ...
      expect(store.connection('gemini-web', true)).toMatchObject({ ready: false, providers: { 'chatgpt-web': true, 'gemini-web': false } })
