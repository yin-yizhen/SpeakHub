...
const storedSchema = z.object({ providers: z.object({ 'chatgpt-web': z.boolean(), 'gemini-web': z.boolean() }), subtitle: subtitleSchema.optional() })
...
export class AppSettingsStore {
  ...
  clear(): void { this.write({ providers: { 'chatgpt-web': false, 'gemini-web': false }, subtitle: defaultSubtitlePreferences }) }

  private read(): z.infer<typeof storedSchema> {
    const fallback = { providers: { 'chatgpt-web': false, 'gemini-web': false } }
