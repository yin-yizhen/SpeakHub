...
const storedSchema = z.object({ providers: z.object({ 'chatgpt-web': z.boolean() }), subtitle: subtitleSchema.optional(), archiveDirectory: z.string().min(1).optional(), microphoneShortcut: z.string().min(1).max(80).optional() })
