...
import { ALIYUN_HELP_LINKS, isExternalHelpUrl, MIMO_HELP_LINKS, SPEECH_MODEL_DOWNLOAD_LINKS } from './help-links'
...
describe('external help links', () => {
  it('allows only the fixed official help and speech model destinations', () => {
    ...
    expect(Object.values(MIMO_HELP_LINKS).every(isExternalHelpUrl)).toBe(true)
