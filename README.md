...
> ⬇️ **Windows 安装包：** [点击下载最新版（v0.2.2）](https://github.com/yin-yizhen/SpeakHub/releases/download/v0.2.2/SpeakHub-0.2.2-Setup.exe) ｜ [查看 Release](https://github.com/yin-yizhen/SpeakHub/releases/latest)
