...
> ⬇️ **Windows 安装包：** [点击下载最新版（v0.1.9）](https://github.com/yin-yizhen/SpeakHub/releases/download/v0.1.9/SpeakHub-0.1.9-Setup.exe) ｜ [查看 Release](https://github.com/yin-yizhen/SpeakHub/releases/latest)
